...
var displayMap = function displayMap(locations) {
  mapboxgl.accessToken = 'pk.eyJ1IjoiZ2FuZXNoam9naSIsImEiOiJja2ltcHZsMHUwaGF6MnBwMzBnd25kdTUzIn0.LQ8jDQDsYiIO2T6B6bgbzg';
        ...
        switch (_context.prev = _context.next) {
          ...
          case 3:
            ...
            if (res.data.status === 'success') {
              (0, _alerts.showAlert)('success', 'logged suceesfully');
      ...
      while (1) {
        switch (_context2.prev = _context2.next) {
          ...
          case 7:
            ...
            (0, _alerts.showAlert)('error', 'error in logout');
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 4:
            ...
            if (res.data.status === 'success') {
              (0, _alerts.showAlert)('success', "".concat(type.toUpperCase(), " updated suceesfully")); //   window.setTimeout(() => {
              //     location.assign('/');
              //   }, 1500);
            }
...
var stripe = Stripe('pk_test_51HyuNVCc68hXdXm38i2slX3yEQRv5rUdMnTjPxL87jbZfBOMTS3Bzj0xKQ3EaOoTVXAqoldmanimmWTtxQKod1Q800stcgxiG7');
...
if (userDataForm) {
  userDataForm.addEventListener('submit', function (e) {
    ...
    console.log(form);
    (0, _updateSettings.updateSettings)(form, 'details');
  });
}
